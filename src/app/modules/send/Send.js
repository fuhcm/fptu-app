...
class Send extends Component {
  ...
  handleSend = () => {
    ...
    message
      ...
      .then(() =>
        message.info("Vui lòng chờ admin xét duyệt, tối đa chờ 2 ngày", 2.5)
      );
  };
    ...
    return (
      <Content style={{ padding: "0 50px" }}>
        <div style={{ background: "#fff", padding: "2rem", minHeight: 540 }}>
          ...
          <p>
            Bạn đang buồn vì chuyện thất tình? Bạn thấy mình không đủ bản lĩnh
            để chắp nối tình yêu? Bạn thấy mình liêu xiêu trong vấn đề tình cảm
            hoặc mối quan hệ của bạn bị kìm hãm bởi những lí do? Và bạn khá đắn
            đo khi hỏi trực tiếp? Đừng lo vì bây giờ đã có confession nơi bạn có
            thể thổ lộ mà đố ai biết được.
          </p>
          <TextArea
