...
class AdminCP extends Component {
    ...
    onLoadMore = () => {
        ...
        this.setState({
            loading: true,
            list: data.concat([...new Array(stepLoad)].map(() => ({ loading: true }))).reverse(),
        });
        ...
        setTimeout(() => this.setState({ data: timeoutDate, list: data, loading: false }), 5000);
    }
