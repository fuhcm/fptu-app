"use strict";
var precacheConfig = [
        ["/index.html", "21d96c0a9a8363c8d5f0f4cd7686e451"],
        ["/static/css/main.3e85daa9.css", "e4d8b3338b4c76c7b92891eed42ccb3c"],
        ["/static/js/main.8c8783a4.js", "cc5582ec53d2faf907076b16bdaf0c16"],
    ],
    cacheName =
    ...
    cleanResponse = function(t) {
        return t.redirected
            ? ("body" in t ? Promise.resolve(t.body) : t.blob()).then(function(
                  e
              ) {
